...
- `clinics.tenant_id` is a NOT NULL FK. Every operational table (`patients`, `appointments`, `treatments`, `cases`, `services`, `product_stocks`, `transactions`, `sms_logs`, `status_logs`, ...) carries a NOT NULL `clinic_id`.
