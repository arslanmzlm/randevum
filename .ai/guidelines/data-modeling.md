...
- Polymorphic `morphTo` always uses a STRING morph-map slug (never class names): `treatments.details`, `status_logs.loggable`, `sms_logs.loggable`, `consents.consentable`, `field_values.entity`.
