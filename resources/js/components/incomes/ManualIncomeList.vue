...
import { IconArrowBackUp, IconPlus, IconTrash } from '@tabler/icons-vue';
...
function openRefund(income: ManualIncome): void {
...
<template>
    <div>
        ...
        >
            ...
            <Column
                field="paid_at"
                :header="t('income.columns.paid_at')"
                sortable
            >
                <template #body="{ data }">
            ...
            <Column
                ...
                class="text-right"
            >
                <template #body="{ data }: { data: ManualIncome }">
                    <span
                        class="font-medium"
                        :class="
            ...
            <Column class="w-28">
                ...
                <template #body="{ data }: { data: ManualIncome }">
                    <div class="flex items-center justify-end">
                        <Button
                            v-if="canRefund && isRefundable(data)"
