...
// Existing-patient search and new-patient fields are mutually exclusive: typing new-patient
// details disables the search, and picking a patient disables the fields.
...
<template>
    <div class="flex flex-col gap-4">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-4 lg:grid-cols-2">
            ...
            <div
                class="flex items-center gap-3 text-xs text-surface-400 lg:col-span-2"
            >
            ...
            <fieldset
                ...
                class="m-0 grid min-w-0 grid-cols-1 gap-4 border-0 p-0 disabled:opacity-60 sm:grid-cols-2 lg:col-span-2"
            >
                <FormField
                ...
                <p class="text-xs text-surface-500 sm:col-span-2">
        ...
        <Link
            ...
            class="inline-flex items-center gap-1 self-start text-xs font-medium text-primary-600 hover:text-primary-700"
        >
