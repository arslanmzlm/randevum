...
return [
    ...
    */
    ...
    'working_hours_closed_conflict' => 'No opening/closing time may be set for :attribute on days marked as closed.',
    'working_hours_open_close_required' => 'Opening and closing times are required for :attribute.',
    'working_hours_time_format' => 'Enter a valid time format (HH:MM) for :attribute.',
    'working_hours_close_after_open' => 'The closing time for :attribute must be after the opening time.',
    'working_hours_break_format' => ':attribute must include a break start and end time.',
    'working_hours_break_end_after_start' => 'The break end time for :attribute must be after the start time.',
    'working_hours_break_within_hours' => 'The break for :attribute must fall within working hours.',
    ...
    'attributes' => [
        ...
        'details.treatment_process' => 'treatment process',
        'discount_amount' => 'discount amount',
        'services' => 'services',
        'services.*.service_id' => 'service',
        'services.*.quantity' => 'quantity',
        'services.*.unit_price' => 'unit price',
        'services.*.discount_amount' => 'service discount',
        'products' => 'products',
        'products.*.product_id' => 'product',
        'products.*.quantity' => 'quantity',
        'products.*.unit_price' => 'unit price',
        'products.*.discount_amount' => 'product discount',
        'case_mode' => 'case link',
        'case_id' => 'case',
        'new_case_title' => 'case title',
        'payments.*.amount' => 'payment amount',
        'payments.*.method' => 'payment method',
        'follow_up.mode' => 'follow-up type',
        'follow_up.occurrences' => 'session dates',
        'follow_up.occurrences.*' => 'session',
        'follow_up.occurrences.*.starts_at' => 'session date',
        ...
        'installments.*.sequence' => 'installment order',
        'installments.*.due_date' => 'due date',
        'installments.*.amount' => 'installment amount',
        'installment_plan.installment_count' => 'number of installments',
        'installment_plan.down_payment' => 'down payment',
        'installment_plan.down_payment_method' => 'down payment method',
        'installment_plan.installments.*.due_date' => 'due date',
