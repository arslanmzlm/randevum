 ...
 * but the page lives in Core, and the shared kernel must not import a sibling module concretely.
 * Core resolves whatever the container has bound (nothing, when the Messaging module is
 * absent — the tab is then simply not rendered).
 */
